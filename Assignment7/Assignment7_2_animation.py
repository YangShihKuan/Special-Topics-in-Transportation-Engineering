...
#people_movement.txt
action_key = []
outfile = open('people_movement2.txt','r')
for row in outfile:
    word = row.split(' ')
    del word[-1]
    xy = []
...
'''
text_2_id=c.create_text((door_coordinate[0]+xy_shift)*x_range, canvas_height-(door_coordinate[1]+xy_shift)*x_range, text='*',fill="black")
